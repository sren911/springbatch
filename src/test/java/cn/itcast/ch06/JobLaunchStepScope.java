...
public class JobLaunchStepScope {
    public static void main(String[] args) {
        executeJob("classpath:ch06/job/job-stepscope.xml", "billJob", new JobParametersBuilder().addDate("date", new Date()).addString("inputResource", "classpath:ch06/data/credit-card-bill-201303.csv"));
    }
