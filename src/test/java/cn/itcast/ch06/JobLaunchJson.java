...
public class JobLaunchJson {
    public static void main(String[] args) {
        executeJob("classpath:ch06/job/job-jsion.xml", "billJob", new JobParametersBuilder().addDate("date", new Date()).addString("inputResource", "classpath:ch06/data/credit-card-bill-201303.json"));
    }
