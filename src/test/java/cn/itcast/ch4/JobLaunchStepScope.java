...
public class JobLaunchStepScope {
    public static void main(String[] args) {
        executeJob("classpath:ch04/job/job-stepscope.xml", "billJob", new JobParametersBuilder().addDate("date", new Date()).addString("inputResource", "classpath:ch04/data/credit-card-bill-201303.csv"));
    }
